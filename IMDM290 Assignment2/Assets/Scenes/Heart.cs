...
public class heart : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int i =0; i < numSphere; i++){
            ...
            endPosition[i] = new Vector3( Mathf.Sqrt(2) * sin * sin * sin, -(cos*cos*cos) - (cos*cos) + 2*cos) * 3f;
            endPosition[i].y += 3.5f;
        }
    ...
    void Update()
    {
        ...
        for (int i =0; i < numSphere; i++){
            ...
            float maxScale = 0.3f;        
            // Big when heart forms, small when dispersed
            float scale = Mathf.Lerp(minScale, maxScale, lerpFraction);
    ...
    void firework()
    {
        for (int i =0; i < numSphere; i++){
            ...
            // Position
            spheres[i].transform.position = new Vector3(Random.Range(-10f, 10f), Random.Range(-10f, 10f), Random.Range(-10f, 10f));
